...
START TRANSACTION;
USE `ssocial`;
INSERT INTO `ssocial`.`admin` (`id_admin`, `admin_nombre`, `admin_user`, `admin_pass`) VALUES (1, 'ADMINISTRADOR', 'admin', 'de5bbd7c6f5db21568d17697d2761605');
